            ...
            <form class="cart mb-6" method="post" enctype="multipart/form-data">
                <div class="mb-6">
                    ...
                    <?php
                        ...
                        <div class="bulk-quantity-buttons mb-4">
                            <label class="inline-flex items-center mr-2 cursor-pointer">
                                <input type="radio" name="quantity" value="54" checked class="hidden" />
                                <span class="small-bulk px-4 py-2 border rounded">54 pcs</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="quantity" value="99" class="hidden" />
                                <span class="big-bulk px-4 py-2 border rounded">99 pcs</span>
                            </label>
                        </div>
                        <?php else : ?>
                            <div class="mb-2">
                ...
                <div class="flex flex-col max-md:w-full">
                    ...
                    <button id="lone-add-to-cart" type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="bg-blue text-white hover:bg-blue-dark p-2 transition-colors duration-300">
                        Add to cart
                    </button>
                </div>
            </form>
