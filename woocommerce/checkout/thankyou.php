...
<div class="max-w-2xl mx-auto py-16 px-4 text-left text-gray-800 font-sans">
  ...
  <div class="text-sm text-gray-700 text-center">
    ...
    <p>
      Email us at <a href="mailto:support@example.com" class="text-blue hover:underline">info@lonemagnet.com</a>
    </p>
  </div>

  <div class="text-center mt-10">
    <a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>"
       class="btn inline-block text-white text-sm tracking-wide px-6 py-3 font-medium transition">
      Continue Shopping
    </a>
  </div>
