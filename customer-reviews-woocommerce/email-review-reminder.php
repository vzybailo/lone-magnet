																	...
																	<table border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; margin-bottom: 10px; display: inline-block;">
																		<tr>
																			<td align="center" style="border-radius: 5px; background-color: <?php echo $cr_email_color_bg; ?>; text-align: center;">
																				<a rel="noopener" target="_blank" href="https://lonemagnet.com/product/custom-photo-magnets/#reply-title" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: <?php echo $cr_email_color_text; ?>; font-weight: bold; text-decoration: none;border-radius: 5px; padding: 10px 20px; border: 1px solid #bf0a30; display: inline-block; background-color: #bf0a30;">
