  ...
  <div class="container mx-auto px-4 max-w-7xl">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10 text-left">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="/refund_returns" class="hover:underline">Refund Policy</a></li>
    ...
    <div class="flex justify-between border-t border-gray-700 pt-6 mt-6 text-xs text-gray-400 max-md:flex-col">
      ...
      <div class="flex flex-col justify-between flex-wrap items-end gap-1">
        <p class="inline-flex items-center justify-center gap-1 text-xs max-md:text-center max-md:w-full">
